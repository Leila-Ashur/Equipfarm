...
const Login = () => {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    try {      console.log("login user", user)
      const loginuser = await axios.post("https://678e-41-80-114-248.ngrok-free.app/api/login/", {
      "username":user.username,
      "phone_number": user.phone_number
   });
      console.log("login api details", loginuser)
      router.push('/payment');    } catch (error:any) {
        ...
        <div className="w-full bg-white flex flex-col p-16 sm:w-1/2 sm:p-20 mt-[-1.%]">
          <div className="justify-center mt-2">
            ...
            <div className="relative text-black flex item-center border-solid border-2 border-black  justify-center">
                ...
                <br/>              <div className="mb-4 sm:mb-5 w-/3">
              ...
              <div className="flex items-center mb-4 sm:mb-5">
                ...
                <div className="ml-auto">
                  <a href="#" className="text-sm text-[#287100] ">                  </a>
                </div>
              </div>
              <button
              ...
              {/* <button className="bg-[#287100
] text-white  sm:w-1/2 text-xl py-2 px-05">
                Login
              </button> */}
              <div className="flex items-center mt-4">
                <div className="text-sm text-[#4B4B4B]">
                  Don't have an account?
                  <Link href="/dashboardsignup/">
