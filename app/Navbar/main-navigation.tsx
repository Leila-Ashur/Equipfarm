      ...
      <div className="flex items-center justify-between">
        ...
        <ul className="navbar-list md:flex justify-center mt-4">
          <li className="navbar-item">
            <Link
              href="/"
              className="text-black hover:text-black-300 px-3 py-2 block"
            >
              Home
            </Link>
          </li>
...
// const MainNavigation = () => {
//   const { totalProducts } = useCart();
//   const [pathname, setPathname] = useState(""); // Store the current pathname

//   useEffect(() => {
//     // Get and update the current pathname
...
//   // Conditionally render the navigation bar based on the current page
//   if (isLoginPage || isSignupPage) {
//     return null; // Do not render the navigation bar on login and signup pages
//   }
